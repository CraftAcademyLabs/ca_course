...
All cucumber tests are written in `.feature` files. Add the following basic feature definition that we will use to finalize the basic configuration of cucumber-js
