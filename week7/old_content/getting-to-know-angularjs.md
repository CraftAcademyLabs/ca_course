...
1. Your very basic HTML page is extended with AngularJS **directives** by loading it from a CDN (see explanation below). AngularJS starts automatically when the web page has loaded.
